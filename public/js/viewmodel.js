...
function styleHelper() {
	this.setGridSize = function(level) {
		...
		$('.gamerow').css('margin-right', (margin * (-1)) / 2);
		$('.gamerow').css('margin-left', (margin ) / 2);
		$('.gamerow').css('margin-bottom', margin);
		$('.gamerow').css('margin-top', margin);
...
function Game() {
	...
	this.updateCounts = function() {
		$(".content-block-title .currLevel").html("<h2>Level: <b>" + this.level + "</b></h2>");
